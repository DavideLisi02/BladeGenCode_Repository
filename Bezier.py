...
class Bezier:
    ...
    def __init__(self, parameters, **kwargs):
        ...
        if self.parameters.object == 'Blade' and self.parameters.definition == 'beta-M%':
            ...
            if self.parameters.spline_degree == 2:
                self.points = np.array([((1 - m/100)**2 * self.P0 + 2 * (1 - m/100) * m/100 * self.parameters.w1 * self.P1 + (m/100)**2 * self.P2) /
