...
def create_RGP(package_path, project_path, case_name, simulation_definition):
    ...
    process = subprocess.Popen(['matlab', '-batch', r"cd('%s\CFXsetup_files'); addpath('C:\Program Files (x86)\REFPROP\wrapper'); rgpGen('%s\%s\buffer_files','%s',%f,%f,%f,%f,%f,%f,%f,%f,%f); exit"%(package_path, project_path, case_name, simulation_definition["fluid name"], simulation_definition["RGP Pmin"], simulation_definition["RGP Pmax"], simulation_definition["RGP Tmin"], simulation_definition["RGP Tmax"], simulation_definition["RGP Tsatmin"], simulation_definition["RGP Tsatmax"], simulation_definition["RGP nP"], simulation_definition["RGP nT"], simulation_definition["RGP nPsat"])], 
